...
def get_music():
    ...
    music, artist, song_lyrics, translate = search_music(searched_artist, searched_music)
...
def search_music(searched_artist, searched_music):
    ...
    music, artist, song_lyrics, translate = Music.get_Music(searched_artist, searched_music)
    if(music == None):
        music, artist, song_lyrics, translate = get_music_vagalume(searched_artist, searched_music)
        if music :
            Music(artist, music,song_lyrics, searched_artist, searched_music, translate).insert_music()    
